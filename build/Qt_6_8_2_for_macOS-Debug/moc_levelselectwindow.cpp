...
namespace {
struct qt_meta_tag_ZN17LevelSelectWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN17LevelSelectWindowE = QtMocHelpers::stringData(
    "LevelSelectWindow",
    "goToLevel1",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17LevelSelectWindowE[] = {
...
Q_CONSTINIT const QMetaObject LevelSelectWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17LevelSelectWindowE.offsetsAndSizes,
    qt_meta_data_ZN17LevelSelectWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17LevelSelectWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *LevelSelectWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17LevelSelectWindowE.stringdata0))
